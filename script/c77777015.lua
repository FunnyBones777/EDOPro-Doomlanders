--Dark Incantation - Calling
--Scripted by FunnyBones777
local s,id=GetID()
function s.initial_effect(c)
	--Activate this card by targeting 1 face-up DARK Pendulum monster from your Extra Deck, or 1 DARK Pendulum monster in your GY; Special Summon that target
